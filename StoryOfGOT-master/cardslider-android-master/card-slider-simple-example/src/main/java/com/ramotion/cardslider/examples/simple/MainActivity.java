...
public class MainActivity extends AppCompatActivity {
    ...
    private final int[] pics = {R.drawable.s1e1, R.drawable.s1e2, R.drawable.s1e3, R.drawable.s1e4,
            R.drawable.s1e5, R.drawable.s1e6, R.drawable.s1e7, R.drawable.s1e8,
            R.drawable.s1e9, R.drawable.s1e10};

    private final int[] descriptions = {R.string.texts1e1, R.string.texts1e2, R.string.texts1e3,
            R.string.texts1e4, R.string.texts1e5, R.string.texts1e6, R.string.texts1e7,
            R.string.texts1e8, R.string.texts1e9, R.string.texts1e10};
    ...
    private final String[] epiTitle = {"Winter Is Coming", "The Kingsroad", "Lord Snow",
            "Cripples, Bastards, and Broken Things", "The Wolf and the Lion", "A Golden Crown",
            "You Win or You Die", "The Pointy End", "Baelor", "Fire and Blood"};

    private final String[] epiNumber = {"S-1 E-1", "S-1 E-2", "S-1 E-3", "S-1 E-4", "S-1 E-5",
            "S-1 E-6", "S-1 E-7", "S-1 E-8", "S-1 E-9", "S-1 E-10"};
    private final String[] times = {"April 17, 2011    IMDB Rating: 9.0/10",
            "April 24, 2011    IMDB Rating: 8.8/10", "May 1, 2011    IMDB Rating: 8.7/10",
            "May 8, 2011    IMDB Rating: 8.8/10", "May 15, 2011    IMDB Rating: 9.1/10",
            "May 22, 2011    IMDB Rating: 9.2/10", "May 29, 2011    IMDB Rating: 9.3/10",
            "June 5, 2011    IMDB Rating: 9.1/10", "June 12, 2011    IMDB Rating: 9.6/10",
            "June 19, 2011    IMDB Rating: 9.5/10"};
