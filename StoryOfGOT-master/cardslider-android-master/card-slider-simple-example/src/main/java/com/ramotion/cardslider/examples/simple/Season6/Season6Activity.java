package com.ramotion.cardslider.examples.simple.Season6;
...
public class Season6Activity extends AppCompatActivity {
    private final int[][] dotCoords = new int[5][2];
    private final int[] pics = {R.drawable.s6e1, R.drawable.s6e2, R.drawable.s6e3, R.drawable.s6e4,
            R.drawable.s6e5, R.drawable.s6e6, R.drawable.s6e7, R.drawable.s6e8,
            R.drawable.s6e9, R.drawable.s6e10};

    private final int[] descriptions = {R.string.texts6e1, R.string.texts6e2, R.string.texts6e3,
            R.string.texts6e4, R.string.texts6e5, R.string.texts6e6, R.string.texts6e7,
            R.string.texts6e8, R.string.texts6e9, R.string.texts6e10};
    ...
    private final String[] epiTitle = {"The Red Woman", "Home",
    ...
    private final String[] epiNumber = {"S-6 E-1", "S-6 E-2", "S-6 E-3", "S-6 E-4", "S-6 E-5",
            "S-6 E-6", "S-6 E-7", "S-6 E-8", "S-6 E-9", "S-6 E-10"};
    private final String[] times = {"April 24, 2016    IMDB Rating:  8.6/10",
            "May 1, 2016    IMDB Rating: 9.5/10", "May 8, 2016    IMDB Rating: 8.8/10",
            "May 15, 2016    IMDB Rating:  9.2/10", "May 22, 2016    IMDB Rating: 9.7/10",
            "May 29, 2016    IMDB Rating: 8.5/10", "June 5, 2016   IMDB Rating:  8.6/10",
            "June 12, 2016    IMDB Rating:  8.4/10", "June 19, 2016    IMDB Rating: 9.9/10",
            "June 26, 2016   IMDB Rating: 9.9/10"};

    private final SliderAdapter sliderAdapter = new SliderAdapter(pics, 10, new Season6Activity.OnCardClickListener());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_season6);
    ...
    private void initSwitchers() {
        ...
        temperatureSwitcher.setFactory(new Season6Activity.TextViewFactory(R.style.TemperatureTextView, true));
        temperatureSwitcher.setCurrentText(epiNumber[0]);

        placeSwitcher = (TextSwitcher) findViewById(R.id.ts_place);
        placeSwitcher.setFactory(new Season6Activity.TextViewFactory(R.style.PlaceTextView, false));
        placeSwitcher.setCurrentText(epiTitle[0]);

        clockSwitcher = (TextSwitcher) findViewById(R.id.ts_clock);
        clockSwitcher.setFactory(new Season6Activity.TextViewFactory(R.style.ClockTextView, false));
        clockSwitcher.setCurrentText(times[0]);

        descriptionsSwitcher = (TextSwitcher) findViewById(R.id.ts_description);
        descriptionsSwitcher.setInAnimation(this, android.R.anim.fade_in);
        descriptionsSwitcher.setOutAnimation(this, android.R.anim.fade_out);
        descriptionsSwitcher.setFactory(new Season6Activity.TextViewFactory(R.style.DescriptionTextView, false));
...
//    }
    ...
    private void onActiveCardChange(int pos) {
        ...
        temperatureSwitcher.setInAnimation(Season6Activity.this, animH[0]);
        temperatureSwitcher.setOutAnimation(Season6Activity.this, animH[1]);
        temperatureSwitcher.setText(epiNumber[pos % epiNumber.length]);

        placeSwitcher.setInAnimation(Season6Activity.this, animV[0]);
        placeSwitcher.setOutAnimation(Season6Activity.this, animV[1]);
        placeSwitcher.setText(epiTitle[pos % epiTitle.length]);

        clockSwitcher.setInAnimation(Season6Activity.this, animV[0]);
        clockSwitcher.setOutAnimation(Season6Activity.this, animV[1]);
...
//        decodeMapBitmapTask.execute();
    ...
    private class TextViewFactory implements  ViewSwitcher.ViewFactory {
        ...
        public View makeView() {
            final TextView textView = new TextView(Season6Activity.this);
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                textView.setTextAppearance(Season6Activity.this, styleId);
            } else {
    ...
    private class ImageViewFactory implements ViewSwitcher.ViewFactory {
        @Override
        public View makeView() {
            final ImageView imageView = new ImageView(Season6Activity.this);
    ...
    private class OnCardClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (clickedPosition == activeCardPosition) {
                final Intent intent = new Intent(Season6Activity.this, DetailsActivity.class);
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    final ActivityOptions options = ActivityOptions
                            .makeSceneTransitionAnimation(Season6Activity.this, sharedView, "shared");
