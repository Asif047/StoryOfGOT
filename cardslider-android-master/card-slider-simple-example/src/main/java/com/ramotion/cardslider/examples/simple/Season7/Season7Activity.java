package com.ramotion.cardslider.examples.simple.Season7;
...
public class Season7Activity extends AppCompatActivity {

    private final int[][] dotCoords = new int[5][2];
    private final int[] pics = {R.drawable.s7e1, R.drawable.s7e2, R.drawable.s7e3, R.drawable.s7e4,
            R.drawable.s7e5, R.drawable.s7e6, R.drawable.s7e7 };

    private final int[] descriptions = {R.string.texts7e1, R.string.texts7e2, R.string.texts7e3,
            R.string.texts7e4, R.string.texts7e5, R.string.texts7e6, R.string.texts7e7};

    private final String[] episode = {"Episode 1", "Episode 2", "Episode 3", "Episode 4",
            "Episode 5", "Episode 6", "Episode 7"};

    private final String[] epiTitle = {"Dragonstone", "Stormborn",
            "The Queen's Justice", "The Spoils of War", "Eastwatch",
            "Beyond the Wall", "The Dragon and the Wolf"};

    private final String[] epiNumber = {"S-7 E-1", "S-7 E-2", "S-7 E-3", "S-7 E-4", "S-7 E-5",
            "S-7 E-6", "S-7 E-7"};

    private final String[] times = {"July 16, 2017    IMDB Rating:  8.7/10",
            "July 23, 2017    IMDB Rating: 9.0/10", "July 30, 2017    IMDB Rating: 9.3/10",
            "August 6, 2017    IMDB Rating:  9.8/10", "August 13, 2017    IMDB Rating: 9.0/10",
            "August 20, 2017    IMDB Rating: 9.2/10", "August 27, 2017   IMDB Rating:  9.6/10" };

    private final SliderAdapter sliderAdapter = new SliderAdapter(pics, 7, new Season7Activity.OnCardClickListener());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_season7);
    ...
    private void initSwitchers() {
        ...
        temperatureSwitcher.setFactory(new Season7Activity.TextViewFactory(R.style.TemperatureTextView, true));
        temperatureSwitcher.setCurrentText(epiNumber[0]);

        placeSwitcher = (TextSwitcher) findViewById(R.id.ts_place);
        placeSwitcher.setFactory(new Season7Activity.TextViewFactory(R.style.PlaceTextView, false));
        placeSwitcher.setCurrentText(epiTitle[0]);

        clockSwitcher = (TextSwitcher) findViewById(R.id.ts_clock);
        clockSwitcher.setFactory(new Season7Activity.TextViewFactory(R.style.ClockTextView, false));
        clockSwitcher.setCurrentText(times[0]);

        descriptionsSwitcher = (TextSwitcher) findViewById(R.id.ts_description);
        descriptionsSwitcher.setInAnimation(this, android.R.anim.fade_in);
        descriptionsSwitcher.setOutAnimation(this, android.R.anim.fade_out);
        descriptionsSwitcher.setFactory(new Season7Activity.TextViewFactory(R.style.DescriptionTextView, false));
...
//    }
    ...
    private void onActiveCardChange(int pos) {
        ...
        temperatureSwitcher.setInAnimation(Season7Activity.this, animH[0]);
        temperatureSwitcher.setOutAnimation(Season7Activity.this, animH[1]);
        temperatureSwitcher.setText(epiNumber[pos % epiNumber.length]);

        placeSwitcher.setInAnimation(Season7Activity.this, animV[0]);
        placeSwitcher.setOutAnimation(Season7Activity.this, animV[1]);
        placeSwitcher.setText(epiTitle[pos % epiTitle.length]);

        clockSwitcher.setInAnimation(Season7Activity.this, animV[0]);
        clockSwitcher.setOutAnimation(Season7Activity.this, animV[1]);
...
//        decodeMapBitmapTask.execute();
    ...
    private class TextViewFactory implements  ViewSwitcher.ViewFactory {
        ...
        public View makeView() {
            final TextView textView = new TextView(Season7Activity.this);
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                textView.setTextAppearance(Season7Activity.this, styleId);
            } else {
    ...
    private class ImageViewFactory implements ViewSwitcher.ViewFactory {
        @Override
        public View makeView() {
            final ImageView imageView = new ImageView(Season7Activity.this);
    ...
    private class OnCardClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (clickedPosition == activeCardPosition) {
                final Intent intent = new Intent(Season7Activity.this, DetailsActivity.class);
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    final ActivityOptions options = ActivityOptions
                            .makeSceneTransitionAnimation(Season7Activity.this, sharedView, "shared");
