package com.ramotion.cardslider.examples.simple.Season3;
...
public class Season3Activity extends AppCompatActivity {
    ...
    private final int[] pics = {R.drawable.s3e1, R.drawable.s3e2, R.drawable.s3e3, R.drawable.s3e4,
            R.drawable.s3e5, R.drawable.s3e6, R.drawable.s3e7, R.drawable.s3e8,
            R.drawable.s3e9, R.drawable.s3e10};

    private final int[] descriptions = {R.string.texts3e1, R.string.texts3e2, R.string.texts3e3,
            R.string.texts3e4, R.string.texts3e5, R.string.texts3e6, R.string.texts3e7,
            R.string.texts3e8, R.string.texts3e9, R.string.texts3e10};
    ...
    private final String[] epiTitle = {"Valar Dohaeris", "Dark Wings, Dark Words",
            "Walk of Punishment", "And Now His Watch Is Ended", "Kissed by Fire",
            "The Climb", "The Bear and the Maiden Fair", "Second Sons",
            "The Rains of Castamere", "Mhysa"};

    private final String[] epiNumber = {"S-3 E-1", "S-3 E-2", "S-3 E-3", "S-3 E-4", "S-3 E-5",
            "S-3 E-6", "S-3 E-7", "S-3 E-8", "S-3 E-9", "S-3 E-10"};
    private final String[] times = {"March 31, 2013    IMDB Rating:  8.9/10",
            "April 7, 2013    IMDB Rating: 8.6/10", "April 14, 2013    IMDB Rating: 8.9/10",
            "April 21, 2013   IMDB Rating:  9.6/10", "April 28, 2013    IMDB Rating: 9.0 /10",
            "May 5, 2013    IMDB Rating: 8.9/10", "May 12, 2013    IMDB Rating:  8.8/10",
            "May 19, 2013    IMDB Rating:  9.0/10", "June 2, 2013    IMDB Rating: 9.9/10",
            "June 9, 2013   IMDB Rating: 9.2/10"};

    private final SliderAdapter sliderAdapter = new SliderAdapter(pics, 10, new Season3Activity.OnCardClickListener());
    ...
    private void initSwitchers() {
        ...
        temperatureSwitcher.setFactory(new Season3Activity.TextViewFactory(R.style.TemperatureTextView, true));
        temperatureSwitcher.setCurrentText(epiNumber[0]);

        placeSwitcher = (TextSwitcher) findViewById(R.id.ts_place);
        placeSwitcher.setFactory(new Season3Activity.TextViewFactory(R.style.PlaceTextView, false));
        placeSwitcher.setCurrentText(epiTitle[0]);

        clockSwitcher = (TextSwitcher) findViewById(R.id.ts_clock);
        clockSwitcher.setFactory(new Season3Activity.TextViewFactory(R.style.ClockTextView, false));
        clockSwitcher.setCurrentText(times[0]);

        descriptionsSwitcher = (TextSwitcher) findViewById(R.id.ts_description);
        descriptionsSwitcher.setInAnimation(this, android.R.anim.fade_in);
        descriptionsSwitcher.setOutAnimation(this, android.R.anim.fade_out);
        descriptionsSwitcher.setFactory(new Season3Activity.TextViewFactory(R.style.DescriptionTextView, false));
...
//    }
    ...
    private void onActiveCardChange(int pos) {
        ...
        temperatureSwitcher.setInAnimation(Season3Activity.this, animH[0]);
        temperatureSwitcher.setOutAnimation(Season3Activity.this, animH[1]);
        temperatureSwitcher.setText(epiNumber[pos % epiNumber.length]);

        placeSwitcher.setInAnimation(Season3Activity.this, animV[0]);
        placeSwitcher.setOutAnimation(Season3Activity.this, animV[1]);
        placeSwitcher.setText(epiTitle[pos % epiTitle.length]);

        clockSwitcher.setInAnimation(Season3Activity.this, animV[0]);
        clockSwitcher.setOutAnimation(Season3Activity.this, animV[1]);
...
//        decodeMapBitmapTask.execute();
    ...
    private class TextViewFactory implements  ViewSwitcher.ViewFactory {
        ...
        public View makeView() {
            final TextView textView = new TextView(Season3Activity.this);
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                textView.setTextAppearance(Season3Activity.this, styleId);
            } else {
    ...
    private class ImageViewFactory implements ViewSwitcher.ViewFactory {
        @Override
        public View makeView() {
            final ImageView imageView = new ImageView(Season3Activity.this);
    ...
    private class OnCardClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (clickedPosition == activeCardPosition) {
                final Intent intent = new Intent(Season3Activity.this, DetailsActivity.class);
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    final ActivityOptions options = ActivityOptions
                            .makeSceneTransitionAnimation(Season3Activity.this, sharedView, "shared");
