package com.ramotion.cardslider.examples.simple.Season2;
...
public class Season2Activity extends AppCompatActivity {
    ...
    private final int[] pics = {R.drawable.s2e1, R.drawable.s2e2, R.drawable.s2e3, R.drawable.s2e4,
            R.drawable.s2e5, R.drawable.s2e6, R.drawable.s2e7, R.drawable.s2e8,
            R.drawable.s2e9, R.drawable.s2e10};

    private final int[] descriptions = {R.string.texts2e1, R.string.texts2e2, R.string.texts2e3,
            R.string.texts2e4, R.string.texts2e5, R.string.texts2e6, R.string.texts2e7,
            R.string.texts2e8, R.string.texts2e9, R.string.texts2e10};
    ...
    private final String[] epiTitle = {"The North Remembers", "The Night Lands",
    ...
    private final String[] epiNumber = {"S-2 E-1", "S-2 E-2", "S-2 E-3", "S-2 E-4", "S-2 E-5",
            "S-2 E-6", "S-2 E-7", "S-2 E-8", "S-2 E-9", "S-2 E-10"};
    private final String[] times = {"April 1, 2012    IMDB Rating:  8.9/10",
            "April 8, 2012    IMDB Rating: 8.6/10", "April 15, 2012    IMDB Rating: 8.9/10",
            "April 22, 2012    IMDB Rating:  8.9/10", "April 29, 2012    IMDB Rating: 8.9 /10",
            "May 6, 2012    IMDB Rating: 9.1/10", "May 13, 2012    IMDB Rating:  9.0/10",
            "May 20, 2012    IMDB Rating:  8.9/10", "May 27, 2012    IMDB Rating: 9.7/10",
            "June 3, 2012    IMDB Rating: 9.4/10"};

    private final SliderAdapter sliderAdapter = new SliderAdapter(pics, 10, new Season2Activity.OnCardClickListener());
    ...
    private void initSwitchers() {
        ...
        temperatureSwitcher.setFactory(new Season2Activity.TextViewFactory(R.style.TemperatureTextView, true));
        temperatureSwitcher.setCurrentText(epiNumber[0]);

        placeSwitcher = (TextSwitcher) findViewById(R.id.ts_place);
        placeSwitcher.setFactory(new Season2Activity.TextViewFactory(R.style.PlaceTextView, false));
        placeSwitcher.setCurrentText(epiTitle[0]);

        clockSwitcher = (TextSwitcher) findViewById(R.id.ts_clock);
        clockSwitcher.setFactory(new Season2Activity.TextViewFactory(R.style.ClockTextView, false));
        clockSwitcher.setCurrentText(times[0]);

        descriptionsSwitcher = (TextSwitcher) findViewById(R.id.ts_description);
        descriptionsSwitcher.setInAnimation(this, android.R.anim.fade_in);
        descriptionsSwitcher.setOutAnimation(this, android.R.anim.fade_out);
        descriptionsSwitcher.setFactory(new Season2Activity.TextViewFactory(R.style.DescriptionTextView, false));
...
//    }
    ...
    private void onActiveCardChange(int pos) {
        ...
        temperatureSwitcher.setInAnimation(Season2Activity.this, animH[0]);
        temperatureSwitcher.setOutAnimation(Season2Activity.this, animH[1]);
        temperatureSwitcher.setText(epiNumber[pos % epiNumber.length]);

        placeSwitcher.setInAnimation(Season2Activity.this, animV[0]);
        placeSwitcher.setOutAnimation(Season2Activity.this, animV[1]);
        placeSwitcher.setText(epiTitle[pos % epiTitle.length]);

        clockSwitcher.setInAnimation(Season2Activity.this, animV[0]);
        clockSwitcher.setOutAnimation(Season2Activity.this, animV[1]);
...
//        decodeMapBitmapTask.execute();
    ...
    private class TextViewFactory implements  ViewSwitcher.ViewFactory {
        ...
        public View makeView() {
            final TextView textView = new TextView(Season2Activity.this);
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                textView.setTextAppearance(Season2Activity.this, styleId);
            } else {
    ...
    private class ImageViewFactory implements ViewSwitcher.ViewFactory {
        @Override
        public View makeView() {
            final ImageView imageView = new ImageView(Season2Activity.this);
    ...
    private class OnCardClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (clickedPosition == activeCardPosition) {
                final Intent intent = new Intent(Season2Activity.this, DetailsActivity.class);
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    final ActivityOptions options = ActivityOptions
                            .makeSceneTransitionAnimation(Season2Activity.this, sharedView, "shared");
